...
export const AddPostAndCollectionListToUser = (where, object) => {
  if (where === "post") {
    ...
    PATH = `${APPNAME}/Users/${object.userid}/getCollectionList/${object.postid}/`;
  }
  const pathReference = firebase.database().ref(PATH);
  pathReference.set({
    userid: object.userid,
...
export const RemovePostAndCollectionToUser = (where, userid, postid) => {
  if (where === "post") {
    PATH = `${APPNAME}/Users/${userid}/getPostList/${postid}/`;
  } else if (where === "collection") {
    PATH = `${APPNAME}/Users/${userid}/getCollectionList/${postid}/`;
  } else if (where === "feed") {
